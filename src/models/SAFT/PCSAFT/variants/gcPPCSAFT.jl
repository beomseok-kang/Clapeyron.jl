struct gcPPCSAFTParam <: EoSParam
...
abstract type gcPPCSAFTModel <: Union{gcPCSAFTModel,PPCSAFTModel} end
@newmodelgc gcPPCSAFT gcPPCSAFTModel gcPPCSAFTParam true true
default_references(::Type{gcPPCSAFT}) = ["10.1021/ie0003887", "10.1021/ie010954d"]
default_locations(::Type{gcPPCSAFT}) = ["SAFT/PCSAFT/gcPPCSAFT","properties/molarmass_groups.csv"]
default_gclocations(::Type{gcPPCSAFT}) = ["SAFT/PCSAFT/gcPPCSAFT/gcPPCSAFT_groups.csv","SAFT/PCSAFT/gcPPCSAFT/gcPPCSAFT_intragroups.csv"]
function transform_params(::Type{gcPPCSAFT},params,groups)
  sigma = params["sigma"]
  sigma.values .*= 1E-10
...
## Description
Heterogeneous Group-contribution Polar Perturbed-Chain SAFT (gc-PPC-SAFT)
## References
1. NguyenHuynh D., et al. (2008). Application of GC-SAFT EOS to Polar Systems Using a Segment Approach. Fluid Phase Equilibria, 264, 62-75. [doi:10.1016/j.fluid.2007.10.019](https://doi.org/10.1016/j.fluid.2007.10.019)
"""
gcPPCSAFT
